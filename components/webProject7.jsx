    ...
    >
      <CardContainer className="inter-var relative m-2 w-full h-auto">
        <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
          ...
          >
            Responsive Travel Agency Landing Page using Next Js 15 and Tailwind
            CSS. This website is designed for a travel agency. It has a menu,
          ...
          <div className="flex justify-between items-center mt-10">
            <CardItem
              translateZ={20}
              as={Link}
              href="https://travel-agency-landing-page-eight.vercel.app/"
              target="__blank"
            ...
            <CardItem
              ...
              as={Link}
              target="__blank"
              href="https://github.com/ShohorabHShawon/Travel-Agency-Landing-Page-NextJs-15"
