    ...
    <section className="relative left-1/2 right-1/2 w-screen -translate-x-1/2 bg-[#fff3d6] py-14 dark:bg-[#121214] min-h-screen">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <h2 className="font-poppins text-4xl font-black uppercase text-[#111] [text-shadow:3px_3px_0px_#ff5a36] dark:text-[#f6f2e8] dark:[text-shadow:3px_3px_0px_#2ac6ff] lg:text-5xl">
            Mission Archive
          </h2>
        ...
        <div className="rounded-2xl border-[4px] border-[#131313] bg-white p-4 shadow-[8px_8px_0_0_#131313] dark:border-[#f6f2e8] dark:bg-[#1b1c21] dark:shadow-[8px_8px_0_0_#f6f2e8] lg:p-6">
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-12">
                  ...
                  <button
                    ...
                    className={`rounded-md border-[3px] px-3 py-2 text-left text-sm font-black uppercase tracking-wide transition-transform hover:-translate-y-0.5 ${
                      activeProject.id === project.id
                        ? 'border-[#131313] bg-[#2ac6ff] text-[#111] shadow-[4px_4px_0_0_#131313] dark:border-[#f6f2e8] dark:shadow-[4px_4px_0_0_#f6f2e8]'
                        : 'border-[#131313]/25 bg-[#fff6e2] text-[#111] dark:border-white/25 dark:bg-white/10 dark:text-white'
                    }`}
                  >
                    {project.title}
                  </button>
            ...
            <div className="lg:col-span-8">
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="relative mb-4 aspect-video overflow-hidden rounded-xl border-[3px] border-[#131313] dark:border-[#f6f2e8]">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {activeProject.tags.map((tag) => (
                      <span key={tag} className="rounded-md border-2 border-[#131313] bg-[#ffea00] px-2 py-1 text-[11px] font-black uppercase text-[#111] dark:border-[#f6f2e8]">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="mt-5 flex flex-wrap gap-3">
                    {activeProject.live && (
                      <Link
                        ...
                        target="_blank"
                        className="inline-flex items-center gap-2 rounded-md border-[3px] border-[#131313] bg-[#131313] px-4 py-2 text-xs font-black uppercase tracking-wide text-white shadow-[4px_4px_0_0_#ff5a1f] dark:border-[#f6f2e8] dark:bg-[#f6f2e8] dark:text-[#131313]"
                      >
                    ...
                    <Link
                      ...
                      target="_blank"
                      className="inline-flex items-center gap-2 rounded-md border-[3px] border-[#131313] bg-white px-4 py-2 text-xs font-black uppercase tracking-wide text-[#111] shadow-[4px_4px_0_0_#131313] dark:border-[#f6f2e8] dark:bg-white/10 dark:text-white dark:shadow-[4px_4px_0_0_#f6f2e8]"
                    >
                      <FiGithub /> Source
                    </Link>
                  </div>
