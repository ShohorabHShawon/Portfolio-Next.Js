    ...
    >
      <CardContainer className="inter-var relative p-1 m-2 w-full h-auto">
        <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
          ...
          >
            Food Delivery Website Ui Design and Prototype using Figma.
          </CardItem>
          ...
          <div className="flex justify-between items-center mt-10">
            ...
            <CardItem
              translateZ={20}
              as={Link}
              href="https://www.figma.com/proto/clVgRF2aB3JTGS2beIqcOd/Hungry.com?node-id=0-1&t=CrEGqnhZsHcZOGes-1"
              target="__blank"
