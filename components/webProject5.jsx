    ...
    >
      <CardContainer className="inter-var relative m-2 w-full h-auto">
        <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
          ...
          >
            Hungry Restaurant Website Design.
          </CardItem>
          <CardItem
            as="p"
            translateZ="60"
          ...
          >
            Hungry Restaurant Website Design using Next Js and Tailwind CSS.
            This website is designed for a restaurant. It has a menu, about, and
            contact page.
          </CardItem>
          ...
          <div className="flex justify-between items-center mt-10">
            <CardItem
              translateZ={20}
              as={Link}
              href="https://hungryrestaurant.vercel.app/"
              target="__blank"
            ...
            <CardItem
              ...
              as={Link}
              target="__blank"
              href="https://github.com/ShohorabHShawon/Hungry"
