  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 md:grid-cols-12 md:gap-8">
        <motion.div initial="hidden" animate="visible" className="md:col-span-7">
          <motion.p
            variants={fadeIn}
            custom={0.02}
          ...
          <motion.h1
            variants={fadeIn}
            custom={0.1}
            className="font-poppins text-4xl font-semibold leading-[1.02] text-[#111827] dark:text-[#f5f4ef] sm:text-5xl lg:text-6xl"
          >
          ...
          <motion.div variants={fadeIn} custom={0.34} className="mt-8 flex items-center gap-3">
            <a
        ...
        >
          <div className="relative mx-auto max-w-sm overflow-hidden rounded-3xl border border-[#1f2937]/10 bg-white p-4 shadow-sm dark:border-[#94a3b8]/25 dark:bg-[#121b26]">
