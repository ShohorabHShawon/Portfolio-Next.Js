      ...
      >
        {navItems.map((navItem, idx) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative font-bold dark:text-neutral-50 items-center space-x-1 text-neutral-600 hover:scale-125 transform transition duration-300 ease-in-out inline-block"
            )}
          >
