...
export default function Skills() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 text-center mb-10">
      {isMounted && (
        <motion.div
        ...
        >
          <ul className="text-base sm:text-[12px] md:text-[16px] list-disc list-inside space-y-4 sm:space-y-6 md:space-y-8">
            {[
              {
                  ...
                  {category.icons.map((icon, idx) => (
                    ...
                    >
                      <Image
                        ...
                        alt={icon.title}
                        title={icon.title}
                        className="w-2 h-3 sm:w-4 sm:h-4 md:w-6 md:h-6 lg:h-8 lg:w-8"
                        width={40}
                        height={40}
                      />
                    </motion.div>
