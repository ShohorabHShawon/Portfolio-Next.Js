...
export default function PostShareActions({ url, title, variant = 'modern' }) {
  ...
  const buttonClass = isManga
    ...
    : 'blog-share-btn inline-flex min-h-[42px] items-center justify-center rounded-full border border-[#d0d0d0] bg-white px-4 py-2 text-xs font-medium text-[#3f3f3f] transition hover:border-[#191919] hover:text-[#191919] dark:border-[#3a3a3a] dark:bg-transparent dark:text-[#d1d1d1] dark:hover:border-[#f3f3f3] dark:hover:text-[#f3f3f3]';
